...
import com.kaya.mvc.App;
import com.kaya.mvc.R;
import com.kaya.mvc.data.DiariesRepository;
...
public class DiariesController {
    ...
    private void showInputDialog(final Diary data) { // 弹出输入对话框
        ...
        new AlertDialog.Builder(mView.getContext()).setTitle(data.getTitle())
                .setView(editText)
                .setPositiveButton(App.getInstance().getString(R.string.ok),
                ...
                .setNegativeButton(App.getInstance().getString(R.string.cancel), null).show(); // 弹出对话框
    }
}
